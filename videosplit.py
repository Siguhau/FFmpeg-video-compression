...
if __name__ == "__main__":
  ...
  ap.add_argument("-o", "--output", required=False, default='output', help="output video file name")
  ap.add_argument("-vp","--videopath", required=True, help="path to video to split")
  ap.add_argument("-dp", "--destinationpath", required=False, default=os.path.abspath(os.getcwd()), help="path to where the videos should be saved")
  ap.add_argument("-p", "--print", required=False, default=True, help="True/False if program should print anything.")
